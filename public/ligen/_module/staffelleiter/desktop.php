 ...
 */
  ...
  if ( $admin ['usertype'] == "t" )
  {
    ...
    echo "<a data-nsv-dialog='CreateDivision' style='cursor: pointer; text-decoration:none'><img src='$globals[systemicons]desk_neu.png' alt='Neue Staffel' class='sed_admin_icon' />Neue Staffel</a>";
